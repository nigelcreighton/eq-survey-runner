...
if [ "$run_docker" == true ]; then
    docker pull onsdigital/eq-schema-validator:list-collector-changes
    validator="$(docker run -d -p 5001:5000 onsdigital/eq-schema-validator:list-collector-changes)"
    sleep 3
fi
